...
public class TransactionController {
	...
	public ResponseEntity<ApiResponse> filterByType(@Valid @RequestBody TransactionTypeDto transactionTypeDto) {
		log.info("Filtering transactions for wallet {} by type {}", transactionTypeDto.getWalletId(),
		...
		ApiResponse response = new ApiResponse(
				...
				"success", transactions.isEmpty() ? "No transactions found" : "Transactions fetched successfully",
				transactions);
	...
	public ResponseEntity<ApiResponse> filterTransactionsByDate(@Valid @RequestBody TransactionDateRangeDto dto) {
