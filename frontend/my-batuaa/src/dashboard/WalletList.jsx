...
return (
    ...
    <Card sx={{ maxWidth: 345 ,color:"#0F3A6E", borderRadius: 4, boxShadow: 3, borderColor: '#97175bff' , borderBlockColor: '#ba357cff' }}>
      ...
      <CardActions  className="wallet-card-actions">
        <Button size="medium" color="primary" className="add-wallet-btn">Add Money</Button>
      </CardActions>
    </Card>
